                ...
                <div class="sort-indicator">
                  <div class="sort-icon-wrapper">
                    <svg v-if="sortOrder === 'asc'" class="sort-icon" viewBox="0 0 24 24">
                      <path
                        d="M12 3.375L4.5 13.875h15L12 3.375zM12 6.625l3.875 5.25H8.125L12 6.625zM4.5 15.375h15v2h-15v-2z"
                        fill="currentColor" />
                    </svg>
                    <svg v-else-if="sortOrder === 'desc'" class="sort-icon" viewBox="0 0 24 24">
                      <path
                        d="M12 20.625L19.5 10.125h-15L12 20.625zM12 17.375l-3.875-5.25h7.75L12 17.375zM4.5 8.625h15v-2h-15v2z"
                        fill="currentColor" />
                    </svg>
...
export default {
	...
	methods: {
		...
		async ambilData() {
			try {
				const response = await axios.get(
					`${import.meta.env.VITE_BACKEND_PORT}/v1/products/`,
				);
		...
		async deleteProduct(productId) {
			try {
				await axios.delete(
					`${import.meta.env.VITE_BACKEND_PORT}/v1/products/delete/${productId}`,
				);
